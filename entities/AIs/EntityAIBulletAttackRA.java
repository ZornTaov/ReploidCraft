...
public class EntityAIBulletAttackRA extends EntityAIBase
{
    ...
    public EntityAIBulletAttackRA(EntityLiving par1EntityLiving, float par2, int par3, int par4)
    {
    ...
    private void doRangedAttack()
    {
        ...
        {
        	EntityMetBullet var1 = new EntityMetBullet(this.worldObj, this.entityHost, this.attackTarget);
