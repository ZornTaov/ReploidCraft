...
public class GuiBusterInventory extends GuiContainer
{
	...
	private final InventoryBuster inventory;

	public GuiBusterInventory(ContainerReploidBuster containerItem)
	{
		super(containerItem);
	...
	{
		this.fontRendererObj.drawString(this.inventory.hasCustomInventoryName() ? this.inventory.getInventoryName() : I18n.format(this.inventory.getInventoryName(), new Object[0]), 2, 0, 4210752);
		this.fontRendererObj.drawString(I18n.format("container.inventory", new Object[0]), 26, this.ySize - 96 + 4, 4210752);
	}
