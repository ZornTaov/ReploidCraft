...
public class ContainerReploidArmor extends Container
{
	/** The Item Inventory for this Container */
	public final InventoryArmor inventory;
	...
	private static final int INV_START = InventoryArmor.INV_SIZE, INV_END = INV_START+26,
	...
	public ContainerReploidArmor(EntityPlayer par1Player, InventoryPlayer inventoryPlayer, InventoryArmor inventoryItem)
	{
		...
		for (i = 0; i < InventoryArmor.INV_SIZE; ++i)
		{
