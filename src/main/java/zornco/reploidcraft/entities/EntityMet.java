...
public class EntityMet extends EntityTameable
{
	...
	public EntityMet(World p_i1696_1_)
	{
		super(p_i1696_1_);
		...
		this.tasks.addTask(4, new EntityAIBulletAttack(this, 1.0F, 1, 60));
	...
	public boolean func_142018_a(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_)
	{
		...
		{
			if (p_142018_1_ instanceof EntityMet)
			{
				EntityMet entitywolf = (EntityMet)p_142018_1_;
	...
	public EntityMet createChild(EntityAgeable p_90011_1_)
	{
		EntityMet entitywolf = new EntityMet(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal p_70878_1_)
	{
		...
		else if (!(p_70878_1_ instanceof EntityMet))
		{
			return false;
		}
		else
		{
			EntityMet entitywolf = (EntityMet)p_70878_1_;
